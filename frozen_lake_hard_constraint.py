...
for k in range(K):
    ...
    for step in range(H):
        ...
        # else:
        #     utility=1.0
        if x_11==5 or x_11==7 or x_11==11 or x_11==12:  
            utility =0.0
        elif x_11==4 or x_11==8:
            utility=0
        else:
            utility=1
        ...
        if reach_goal==1:
            ...
            next_st[x1,step,n_h[x1,step,action]-1,action]=x1
                ...
                g_h[x1,step,n_h[x1,step,action]-1,action]=utility/4
     ...
     for h in reversed(range(H)):    
        for states in range(S):
           ...
           for action in range (A):
              phi=beta*(1/math.sqrt(n_h[states,h,action]))
              #phi=0
              qu_r=0
              qu_g=0
              ...
              Q_val_g[states,h,action]=min(qu_g+phi,(H-h)/4)
   ...
   #Y=max(min(Y+eta*(b-(V_g[0,0]/8)),5),0)  
